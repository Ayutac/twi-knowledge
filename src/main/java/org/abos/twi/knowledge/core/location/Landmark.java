...
public record Landmark(String name, boolean natural, LandmassOcean landmassOcean, String wikiLink) implements Named {
    ...
    public static final Landmark FIRST_WANDERING_INN = new Landmark("Wandering Inn", false, LandmassOcean.NORTHERN_IZRIL, WikiHelper.WIKI_URL + "First_Wandering_Inn");
